export const premios = [
	{
		...
		desc: "10% de descuento en tu próximo pedido 🛍️",
		prob: 100
	},
	{
		id: 1,
		icon: '<svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-truck"><path d="M14 18V6a2 2 0 0 0-2-2H4a2 2 0 0 0-2 2v11a1 1 0 0 0 1 1h2"/><path d="M15 18H9"/><path d="M19 18h2a1 1 0 0 0 1-1v-3.65a1 1 0 0 0-.22-.624l-3.48-4.35A1 1 0 0 0 17.52 8H14"/><circle cx="17" cy="18" r="2"/><circle cx="7" cy="18" r="2"/></svg>',
		desc: "delivery gratis + 1 botella de kombucha en tu próxima compra 🛵",
		prob: 100
	},
	{
		id: 2,
	...
	},
	{
		...
		desc: "20% más en tu próximo pedido 🛍️",
		prob: 100
	},
	{
		id: 4,
		icon: '<svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-camera"><path d="M14.5 4h-5L7 7H4a2 2 0 0 0-2 2v9a2 2 0 0 0 2 2h16a2 2 0 0 0 2-2V9a2 2 0 0 0-2-2h-3l-2.5-3z"/><circle cx="12" cy="13" r="3"/></svg>',
		desc: "una sesión de fotos con tu persona favorita 🤤",
		prob: 100
	},
	{
		id: 5,
		...
		desc: "un tanque de 20L para tu fiesta 🤯",
		prob: 100
	},
	{
		id: 6,
